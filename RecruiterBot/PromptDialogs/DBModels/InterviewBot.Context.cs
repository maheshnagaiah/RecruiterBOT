...
namespace PromptDialogs.DBModels
{
    ...
    public partial class InterviewBotEntities : DbContext
    {
        public InterviewBotEntities()
            : base("name=InterviewBotEntities")
        {
        }
        ...
        public virtual int InsertUserJobMapping(Nullable<long> userDetails, Nullable<long> jobListings, Nullable<System.DateTime> interviewScheduledTime, string pointofContact, ObjectParameter userJobMapping, string errorMessage)
        {
            var userDetailsParameter = userDetails.HasValue ?
                new ObjectParameter("UserDetails", userDetails) :
                new ObjectParameter("UserDetails", typeof(long));
    
            var jobListingsParameter = jobListings.HasValue ?
                new ObjectParameter("JobListings", jobListings) :
                new ObjectParameter("JobListings", typeof(long));
    
            var interviewScheduledTimeParameter = interviewScheduledTime.HasValue ?
                new ObjectParameter("InterviewScheduledTime", interviewScheduledTime) :
                new ObjectParameter("InterviewScheduledTime", typeof(System.DateTime));
    
            var pointofContactParameter = pointofContact != null ?
                new ObjectParameter("PointofContact", pointofContact) :
                new ObjectParameter("PointofContact", typeof(string));
    
            var errorMessageParameter = errorMessage != null ?
                new ObjectParameter("errorMessage", errorMessage) :
                new ObjectParameter("errorMessage", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertUserJobMapping", userDetailsParameter, jobListingsParameter, interviewScheduledTimeParameter, pointofContactParameter, userJobMapping, errorMessageParameter);
        }
    
        public virtual int UpdateStatusForCancelledApplication(Nullable<long> userJobMapping)
        {
            var userJobMappingParameter = userJobMapping.HasValue ?
                new ObjectParameter("UserJobMapping", userJobMapping) :
                new ObjectParameter("UserJobMapping", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateStatusForCancelledApplication", userJobMappingParameter);
        }
    }
}
